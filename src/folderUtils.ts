...
export async function moveFileAndAddMeta(app: App, file: TFile, distDirectory: string, reverseTag: string) {
...
export async function moveFileAndRemoveMeta(app: App, file: TFile, reverseTag: string) {
